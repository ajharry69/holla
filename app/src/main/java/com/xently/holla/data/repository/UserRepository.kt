...
class UserRepository internal constructor(
    ...
    override fun getObservableException() =
        (localDataSource ?: remoteDataSource).getObservableException()

    override fun getLocalContact(contact: Contact) =
        (localDataSource ?: remoteDataSource).getLocalContact(contact)

    override val observableContact: LiveData<Contact>
        get() = (localDataSource ?: remoteDataSource).observableContact
