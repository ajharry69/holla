...
package com.xently.holla.providers
...
//        row.add(Root.COLUMN_ICON, R.drawable.ic_provider)
    ...
    override fun createDocument(
        ...
        try {
            ...
            Log.show(LOG_TAG, "Error creating new file $newFile")
        }
    ...
    override fun openDocumentThumbnail(
        ...
        try {
            ...
            Log.show(LOG_TAG, "Error writing thumbnail", e)
            return null
        } finally {
            if (out != null)
                try {
                    ...
                    Log.show(LOG_TAG, "Error closing thumbnail", e)
                }
    ...
    companion object {
        ...
        private val LOG_TAG: String = LocalStorageProvider::class.java.simpleName
